				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<div>
								<font style="font-family:'宋体';font-size:150%;color:black">车票信息表</font>
								...
								<table class="table table-bordered table-striped" id="SortTable">
										...
										<tbody>
											...
											if($dbc){
												...
												while ($traintableInfo = mysqli_fetch_array($result)){
												
													$TicketNumber = $traintableInfo["TicketNumber"];
													$TrainNumber = $traintableInfo["TrainNumber"];
													...
													$Carriage = $traintableInfo['Carriage'];
													$Seat = $traintableInfo['Seat'];
													$Seattype = $traintableInfo['SeatType'];
													$price = $traintableInfo['price'];
													
													if($Seattype == 1)$type = "一等座";
													if($Seattype == 2)$type = "二等座";
													
													echo "<tr>";
													//打印出$traintableInfo这一行
													echo "<td>{$traintableInfo['TicketNumber']}</td>
														  <td>{$traintableInfo['TrainNumber']}</td>
