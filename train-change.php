		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class = "panel-body">
					...
					<form role="form" action="train-change.php" method="post">
							<div class = "row">
								<div class = "col-md-4">
										...
										<?php
											...
											if($num>0){
												...
												while($row = mysqli_fetch_array($r,MYSQLI_ASSOC)){
													...
													echo '<tr>
														<td align = "left"><a href = "train-change-edit.php?tn='.$row['TrainNumber'].'&st='.$row['DepartureTime'].'">Edit</a></td>
														<td align = "left"><a href = "train-change-delete.php?tn='.$row['TrainNumber'].'&st='.$row['DepartureTime'].'">Delete</a></td>
