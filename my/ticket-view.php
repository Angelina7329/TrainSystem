		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class = "panel-body">
					...
					<form role="form" action="ticket-view.php" method="post">
							<div class = "row">
										...
										<?php
											...
											if($num>0){
												...
												while($row = mysqli_fetch_array($r,MYSQLI_ASSOC)){
													echo '<tr>
														<td align = "left"><a href = "edit_ticket.php?tn='.$row['TicketNumber'].'">Edit</a></td>
														<td align = "left"><a href = "delete_ticket.php?tn='.$row['TicketNumber'].'">Delete</a></td>
