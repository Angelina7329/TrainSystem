			...
			<div class="panel panel-default">
				...
				<div class = "panel-body">
					...
					if($_SERVER['REQUEST_METHOD']=='POST'){
						...
						if(empty($errors)){
							$q = "UPDATE ticket SET TrainNumber = '$trn',StartLocation = '$ori',ArrivalLocation = '$des' ,DepartureTime = '$sta' , 
							ArrivalTime = '$arr' WHERE TicketNumber = '$tn'";
							$r = @mysqli_query($dbc,$q);
							if(mysqli_affected_rows($dbc)==1){
								echo '<p>该车次信息已被成功编辑！ </p>';
								$enter = 1;//已被修改
					...
					//总是显示表格
					$q = "SELECT TrainNumber,StartLocation,ArrivalLocation,DepartureTime,ArrivalTime FROM ticket WHERE TicketNumber = '$tn'";
					$r = @mysqli_query($dbc,$q);
					...
					if(mysqli_num_rows($r)==1){
						...
						echo 
						'<form role="form" action="edit_ticket.php" method="post" >
