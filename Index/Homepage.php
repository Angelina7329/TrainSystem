  ...
  <nav class="navbar navbar-inverse" role="banner">
	...
	<div class = "col-md-3">
	 <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><i class="fa fa-sun-o"></i> Easy Go</a>
	  </div>
	</div>
	...
	<div class="collapse navbar-collapse ">
        <ul class="nav navbar-nav">
          <li class="active"><a href="Index/HomePage.php">首页</a></li>
	...
	<div>
	<br/>
		<a href = "http://localhost/NewLogin.html" style = "color:white;font-size:5px">登陆</a>
		
		<a href = "http://localhost/NewRegister.html" style = "color:white;font-size:5px">注册</a>
	  </div>
	</div>
...
<div id="main-slide" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active"> <img class="img-responsive" src="Index/images/slider/bg1.jpg" alt="slider">
      <div class="slider-content">
        <div class="col-md-12 text-center">
          <h2>Welcome to <span class="logo">Easy Go</span></h2>
          <h3>开启你的订票之旅</h3>
          <p><a href="Index/about.html" class="slider btn">预订车票</a> </p>
        </div>
      </div>
    </div>
    <div class="item"> <img class="img-responsive" src="Index/images/slider/bg2.jpg" alt="slider">
      <div class="slider-content">
        <div class="col-md-12 text-center">
          <h2>乘着火车去<strong>旅行</strong></h2>
          <h3>原始密林</h3>
          <p><a href="Index/portfolio.html" class="slider btn">View More</a> </p>
        </div>
      </div>
    </div>
    <div class="item"> <img class="img-responsive" src="Index/images/slider/bg3.jpg" alt="slider">
      <div class="slider-content">
        <div class="col-md-12 text-center">
          <h2>乘着火车去<strong>旅行</strong></h2>
          <h3>情系北美</h3>
...
<section id="recent-works">
  <div class="container">
    <div class="center">
      <h2>去旅行</h2>
      <hr>
      <p class="lead"><span style = "font-family:"微软雅黑">面朝大海，春暖花开。出去看看这人间四月天。</br>我们在合适的时间时间为你提供了合适的旅游线路规划图，我们希望你可以enjoy your travel and easy go. </span><a href="portfolio.html" class="readmore">View all Works →</a></p>
    </div>
    <div class="row">
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="recent-work-wrap"> <img class="img-responsive" src="Index/images/portfolio/small/item1.jpg" alt="">
          <div class="overlay">
            <div class="recent-work-inner">
              <h3><a href="#">Project Title</a> </h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non odio sed eros tristique bibendum.</p>
              <a class="preview" href="Index/images/portfolio/full/item1.jpg" rel="prettyPhoto" title=""><i class="fa fa-search"></i> View</a> </div>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="recent-work-wrap"> <img class="img-responsive" src="Index/images/portfolio/small/item2.jpg" alt="">
          <div class="overlay">
            <div class="recent-work-inner">
              <h3><a href="#">Project Title</a></h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non odio sed eros tristique bibendum.</p>
              <a class="preview" href="Index/images/portfolio/full/item2.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="recent-work-wrap"> <img class="img-responsive" src="Index/images/portfolio/small/item3.jpg" alt="">
          <div class="overlay">
            <div class="recent-work-inner">
              <h3><a href="#">Project Title</a></h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non odio sed eros tristique bibendum.</p>
              <a class="preview" href="Index/images/portfolio/full/item3.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="recent-work-wrap"> <img class="img-responsive" src="Index/images/portfolio/small/item4.jpg" alt="">
          <div class="overlay">
            <div class="recent-work-inner">
              <h3><a href="#">Project Title</a></h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non odio sed eros tristique bibendum.</p>
              <a class="preview" href="Index/images/portfolio/full/item4.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="recent-work-wrap"> <img class="img-responsive" src="Index/images/portfolio/small/item5.jpg" alt="">
          <div class="overlay">
            <div class="recent-work-inner">
              <h3><a href="#">Project Title</a></h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non odio sed eros tristique bibendum.</p>
              <a class="preview" href="Index/images/portfolio/full/item5.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="recent-work-wrap"> <img class="img-responsive" src="Index/images/portfolio/small/item6.jpg" alt="">
          <div class="overlay">
            <div class="recent-work-inner">
              <h3><a href="#">Project Title</a></h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non odio sed eros tristique bibendum.</p>
              <a class="preview" href="Index/images/portfolio/full/item6.jpg" rel="prettyPhoto"><i class="fa fa-search"></i> View</a> </div>
          </div>
        </div>
      </div>
    </div>
...
<div class="copyrights">通信网址 <a href="#" >访问官网</a></div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="about.html" class="readmore">Read More →</a> </div>
      <div class="col-sm-6">
        <div class="accordion">
          <h3>问题 & 回答</h3>
          <br>
