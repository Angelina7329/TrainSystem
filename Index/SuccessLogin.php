...
<header id="header">
  <nav class="navbar navbar-inverse" role="banner">
	...
	<br/>
		<p>
			尊敬的 <a href = "#" style = "color:white"> <?php echo $_SESSION['formusername'] ?> </a> 用户，欢迎您！
				<span style = "color:white">/</span>
			<a href = "http://localhost/Logout.php" style = "color:white">注销</a>
		</p>
	  </div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="Index/about.html" class="readmore">Read More →</a> </div>
      <div class="col-sm-6">
        <div class="accordion">
          <h3>问题 & 回答</h3>
          <br>
