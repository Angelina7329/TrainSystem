		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class = "panel-body">
					<p><a href = "train-change.php">点击返回</a></p>
					<?php
					...
					if($_SERVER['REQUEST_METHOD']=='POST'){
						...
						if(empty($errors)){
							...
							if(mysqli_affected_rows($dbc)==1){
								...
								$enter = 1;//已被修改
								//同时对车票的信息进行编辑
								$sql = "UPDATE ticket SET StartLocation = '$ori',ArrivalLocation = '$des' ,DepartureTime = '$sta' , 
								ArrivalTime = '$arr' WHERE TrainNumber = '$tn' and DepartureTime = '$st'";
								//echo $sql;
					...
					if(mysqli_num_rows($r)==1){
						...
						echo 
						'<form role="form" action="train-change-edit.php" method="post" >
