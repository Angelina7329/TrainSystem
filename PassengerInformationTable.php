				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<div>
								<font style="font-family:'宋体';font-size:150%;color:black">乘客信息表</font>
								...
								<table class="table table-bordered table-striped" id="SortTable">
										...
										<tbody>
											...
											if($dbc){
												...
												while ($PassengerInformation = mysqli_fetch_array($result)){
												
													$formusername = $PassengerInformation["username"];
													$realname = $PassengerInformation["realname"];
													$IDnumber = $PassengerInformation["id"];
													$telephone = $PassengerInformation["telephone"];
													$EmailAddress = $PassengerInformation["email"];												
													
													echo "<tr>";
													//打印出$traintableInfo这一行
													echo "<td>$formusername</td>
														  <td>$realname</td>
														  <td>$IDnumber</td>
														  <td>$telephone</td>
														  <td>$EmailAddress</td>";					 
