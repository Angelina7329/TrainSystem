		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					<div>
						<font style="font-family:'宋体';font-size:150%;color:#2C2E2F">删除车票 -
						<?php
						if(!empty($_GET['tn'])){
							echo $_GET['tn'];
						}
				...
				<div class = "panel-body">
				 <a href = "chepiao-change.php">点击返回</a>
					...
					if($_SERVER['REQUEST_METHOD']=='POST'){
						if($_POST['sure']=='YES'){
							$q = "DELETE FROM ticket WHERE TicketNumber = '$tn' LIMIT 1";
							$r = @mysqli_query($dbc,$q);
							if(mysqli_affected_rows($dbc)==1){
								echo '<p>该车票信息已被成功删除!</p>';
							}else{
								echo'<p style = "color:red">由于以下错误导致该车票信息未被正常删除：</p>';
						...
						$q = "SELECT StartLocation,ArrivalLocation,DepartureTime,TrainNumber FROM ticket WHERE TicketNumber = '$tn'";
						$r = @mysqli_query($dbc,$q);
						if(mysqli_num_rows($r)==1){
							$row = mysqli_fetch_array($r,MYSQLI_NUM);
							
							echo "<h3>你确定要删除这趟从<b>".$row[0]."</b>至<b>".$row[1]."</b>并于<b>".substr($row[2],0,16)."</b>出发的".$row[3]."列车车票吗?</h3>";
							echo'<form role="form" action="chepiao-change-delete.php" method="post">
