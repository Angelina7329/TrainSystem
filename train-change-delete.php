		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class = "panel-body">
				 <a href = "train-change.php">点击返回</a>
					...
					if($_SERVER['REQUEST_METHOD']=='POST'){
						if($_POST['sure']=='YES'){
							...
							if(mysqli_affected_rows($dbc)==1){
								...
								$sql = "DELETE FROM ticket WHERE TrainNumber = '$tn' AND DepartureTime = '$st'";
						...
						if(mysqli_num_rows($r)==1){
							...
							echo'<form role="form" action="train-change-delete.php" method="post">
